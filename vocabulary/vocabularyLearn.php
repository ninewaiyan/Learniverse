...
$vocab = [
    ['Animal', 'animals.jpg', 'animals.php'],
    ['Body Part', 'body_parts.jpg', 'bodyparts.php'],
    ['Vehicle', 'vehicles.jpg', 'vehicles.php'],
    ['Clothing', 'clothings.jpg', 'clothings.php'],
    ['Color', 'colors.png', 'colors.php'],
    ['fruit', 'fruits.jpg', 'fruits.php'],
    ['School Supply', 'school_supply.jpg', 'school-supply.php'],
    ['Sport', 'sports.jpg', 'sports.php'],
    ['Kitchen Item', 'kitchen_items.jpg', 'kitchen-items.php'],
    ['Nature', 'nature.jpg', 'nature.php'],
...
<head>
    ...
    <style>
        ...
        .vocab-card {
            ...
            position: relative;
            /* For child absolute positioning */
            overflow: hidden;
            /* Hide overflow */
        }
...
<body style="background: whitesmoke;">
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4">Learn Vocabulary</h1>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">
                                ...
                                ?>
                                    <div class="col">
                                        <!-- Wrap the entire vocab-card in an anchor tag -->
                                        <a href="<?= $link ?>" class="text-decoration-none" onclick="playSound(event,'click',this)">
                                            <div class="vocab-card shake">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    foreach ($chunk as $item) {
                                        ...
                                        $word = $chunk[$indexInChunk][0];
                                        $image = $chunk[$indexInChunk][1];
                                        $link = $chunk[$indexInChunk][2];
                                    ?>
                                        <div class="col">
                                            <!-- Wrap the entire vocab-card in an anchor tag -->
                                            <a href="<?= $link ?>" class="text-decoration-none" onclick="playSound(event,'click',this)">
    ...
    <button class="btn btn-dark mx-3 me-1 mb-3 rounded-pill" onclick="window.location.href='../views/index.php'"><i class="fa-solid fa-house"></i></button>

    <script>
        // Variable to keep track of the currently playing audio
        let currentAudio = null;

        function playSound(event, word, link) {
            ...
            // Delay navigation slightly (e.g., 500 ms) to allow part of the sound to play
            setTimeout(() => {
