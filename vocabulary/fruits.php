...
$vocab = [
    ...
    ['P', 'Peanut', 'peanut.png'],
    ['P', 'Pear', 'pear.png'],
    ['P', 'Pineapple', 'pineapple.png'],
    ['P', 'Pomegranate', 'pomegranate.png'],
    ['R', 'raspberry', 'raspberry.png'],
    ['S', 'Sapodilla', 'sapodilla.png'],
    ['S', 'Strawberry', 'strawberry.png'],
    ['w', 'Watermenlon', 'watermenlon.png'],
...
<body style="background: whitesmoke;">
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4">Fruits</h1>
