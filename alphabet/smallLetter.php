...
<head>
    ...
    <title>Colorful Alphabet Board</title>
    <style>
        .alphabet-card {
            border-radius: 10px;
...
<body style="background: whitesmoke;">
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4 text-success">Small Letter</h1>
        <a href="capitalLetter.php" class="btn btn-dark mb-3 me-1 rounded-square"><i class="fa-solid fa-retweet"></i>
            A,B,C</a>
        ...
        <!-- Table for Lowercase Letters -->
        <div class="row">
            <?php
            $alphabets = range('a', 'z');  // Changed to small letters
            $colors = [
                "letter-a",
                "letter-b",
                "letter-c",
            ...
            foreach ($alphabets as $index => $letter) {
                ...
                ?>
                <div class="col-3">
                    <div class="card alphabet-card rounded-pill shadow <?= $colors[$index] ?>"
    ...
    <!-- Add JavaScript for playing sounds -->
    <script>
