...
?>
    ...
    <h1 class="text-center text-success mb-5 mt-4">ABC Adventure</h1>
    ...
    <div class="container-fluid ">
        <div class="row align-items-center">
            <div class="col p d-flex justify-content-center align-items-center mb-4" style="height: 100vh;margin-right:5s0px;">
                <button class="prev" id="prev-slide"><i class="fa-solid fa-chevron-left"></i></button>
            </div>
            <div class="col d-flex justify-content-center align-items-center mt-5" style="height: 100vh;margin-right:0px;">
                <?php
